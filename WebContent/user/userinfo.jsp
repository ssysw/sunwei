...
<form method="post" name="reg" action="user/updateCustomer">
	<table cellpadding="3" cellspacing="1" align="center" class="tableborder1" id="table1">
		...
		<tr>
			...
			<input type="text"  name="username" maxLength="8" size="32" disabled value="${customer.name }" style="font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; color: #000000">
		...
		<tr>
			...
			<td class="tablebody1">
			<input type="text" size="32" maxlength="16" name="${customer.telephone }" value="adfadfadfasd" style="font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; color: #000000">
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td class="tablebody2" valign="middle" colspan="2" align="center">
			    ${updatCustomereMsg}  <c:remove var="updatCustomereMsg" scope="session"/>
			</td>
		</tr>
	</table>
</form>
