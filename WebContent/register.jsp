...
<form method="post" name="reg" action="registerCustomer" onsubmit="return checkForm()">
	<table cellpadding="3" cellspacing="1" align="center" class="tableborder1" id="table1">
		...
		<tr>
			...
			<input type="text" maxLength="8" size="32" name="username"  onblur="checkCustomerName(this.value)" style="font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; color: #000000">
			<font color="#FF0000">*</font> <span id="msg"></span></td>
		</tr>
		<tr>
		...
		<tr>
			<td class="tablebody2" valign="middle" colspan="2" align="center">
	           ${registerCustomereMsg }   <c:remove var="registerCustomereMsg" scope="session"/>
	     </td>
		</tr>
	</table>
</form>
